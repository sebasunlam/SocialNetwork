            ...
            <div class="row">
                ...
                <div class="profile-usermenu">
                    <ul class="nav">
                        ...
                        @endforeach
                        <li><a href="{{route("mascota.create")}}"><i class="glyphicon glyphicon-plus"></i> Agregar
                                mascota</a></li>
                    </ul>
                </div>
        ...
        @else
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-2">
                    <a href="{{route("mascota.create")}}" class="btn btn-success"><i
                                class="glyphicon glyphicon-plus"></i> Agregar mascota</a>
                </div>
            </div>
        @endif
    </div>
